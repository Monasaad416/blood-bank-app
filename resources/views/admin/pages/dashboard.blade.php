        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="inner">
                        <h3>{{App\Models\DonationRequest::count()}}</h3>
                    ...
                    <a href="{{route('donation-requests.index')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-6">
                    ...
                    <a href="{{route('posts.all')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-6">
