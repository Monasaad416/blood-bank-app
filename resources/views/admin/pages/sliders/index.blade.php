                                    ...
                                    <div class="col-sm-12">
                                        <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                                            ...
                                            <tr>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Button</th>
                                            ...
                                            <tbody>
                                                @foreach ($sliders as $key=>$slider)
                                                    <tr class="{{$key % 2 == 0 ? 'even' : 'odd'}}}">
                                                        ...
                                                        <td class="dtr-control sorting_1" tabindex="0">{{$slider->title}}</td>
                                                        <td class="dtr-control sorting_1" tabindex="0">{{$slider->text}}</td>
                                                        <td class="dtr-control sorting_1" tabindex="0">{{$slider->button}}</td>
                                                        <td class="dtr-control sorting_1" tabindex="0">
                                                            <img src="{{url('uploads/'.$slider->image)}}" width="70" alt="slider">
                                                        </td>

                                                        <td>
                                                            <a href="{{route("sliders.edit",$slider->id)}}" class="btn btn-sm btn-info mx-1 edit-btn" title="Edit"><i class="fas fa-edit"></i></a>
                                                        </td>
                                                        <td>
                                                            <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-{{$slider->id}}">
                                                                <i class="fas fa-trash-alt"></i>
                                                            </button>
                                                            <!-- Delete modal start -->
                                                            <form action="{{route('donation-requests.destroy',$slider->id)}}" method="POST">
                                                                <div class="modal fade" id="delete-{{$slider->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <p>Are your sure you want to delete slider:{{$slider->tite}}?</p>
                                                                                @csrf
                                                                                {{method_field('delete')}}
