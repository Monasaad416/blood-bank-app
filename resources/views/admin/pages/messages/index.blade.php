...
@section('header-title')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h2 class="text-capitalize d-inline">all messages</h2>
            </div>
        </div>
    </div><!-- /.container-fluid -->
@endsection
                                ...
                                <div class="col-sm-12">
                                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                                        ...
                                        <tr>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Client</th>
                                            @can('message-show')
                                        ...
                                        <tbody>
                                            @foreach ($messages as $key => $message)
                                                <tr class="{{$key % 2 == 0 ? 'even' : 'odd'}}}">
                                                    ...
                                                    <td class="dtr-control sorting_1" tabindex="0">{{$message->title}}</td>
                                                    <td class="dtr-control sorting_1" tabindex="0">{{$message->client->name}}</td>
                                                    <td>
                                                        <a href="{{route("messages.show",['message' => $message ])}}" class="btn btn-sm btn-secondary mx-1" title="Show"><i class="fas fa-eye"></i></a>
                                                    </td>
                                                    <td>
                                                        <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-{{$message->id}}">
                                                            ...
                                                            <div class="modal fade" id="delete-{{$message->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <p>Are your sure you want to delete message from {{$message->client->name}}?</p>
                                                                            @csrf
                                                                            {{method_field('delete')}}
