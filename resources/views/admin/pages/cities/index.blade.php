...
@section('header-title')
    <div class="container-fluid">
        <div class="row mb-2">
        <div class="col-sm-6">
            <h2 class="text-capitalize d-inline">all cities</h2>
        </div>
        @can('city-create')
            <div class="col-sm-6 text-right">
                <button type="button" class="btn btn-primary btn-flat">
                    <a href="{{route('cities.create')}}" class="text-white">Add City</a>
                </button>
            </div>
        @endcan
        </div>
                                    ...
                                    <div class="col-sm-12">
                                        <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                                            ...
                                            <tr>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Governorate</th>
                                                @can('city-edit')
                                            ...
                                            <tbody>
                                                @foreach ($cities as $key=>$city)
                                                    <tr class="{{$key % 2 == 0 ? 'even' : 'odd'}}}">
                                                        ...
                                                        <td class="dtr-control sorting_1" tabindex="0">{{$city->name}}</td>
                                                        <td class="dtr-control sorting_1" tabindex="0">{{$city->governorate->name}}</td>
                                                        @can('city-edit')
                                                            <td>
                                                                <a href="{{route("cities.edit",$city->id)}}" class="btn btn-sm btn-info mx-1 edit-btn" title="Edit"><i class="fas fa-edit"></i></a>
                                                            </td>
                                                        @endcan
                                                        @can('city-delete')
                                                            <td>
                                                                <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-{{$city->id}}">
                                                                    ...
                                                                    <div class="modal fade" id="delete-{{$city->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <p>Are your sure you want to delete city: {{$city->name}}?</p>
